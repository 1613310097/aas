<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="上课班级" prop="shangkebanji">
				<el-input v-model="ruleForm.shangkebanji" 
					placeholder="上课班级" clearable :disabled=" false  ||ro.shangkebanji"></el-input>
			</el-form-item>
			...
			init(type) {
				...
				if(type=='cross'){
					...
					for (var o in obj){
						...
						if(o=='shangkebanji'){
							this.ruleForm.shangkebanji = obj[o];
							this.ro.shangkebanji = true;
							continue;
						}
						if(o=='touxiang'){
