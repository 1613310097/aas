<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"0px 0 0 177px","margin":"0","position":"relative","background":"#F7F8FC","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"none","padding":"0 20px 0","alignItems":"center","color":"#333","display":"flex","justifyContent":"flex-end","top":"0","left":"0","background":"#fff","width":"calc(100% - 0px)","fontSize":"16px","position":"inherit","zIndex":"1001","height":"70px"}'></index-header>
